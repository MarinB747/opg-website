      ...
      <section className="footer-subscription">
        ...
        <div className="input-areas">
          <form className="footer_input" >
            <input type="name" name="name" placeholder="Vaše ime" className="footer-input" />
            <input type="email" name="email" placeholder="Vaš e-mail" className="footer-input" />
            <input type="txt" name="phone" placeholder="Vaš telefon" className="footer-input" />
          </form>
          <form>
          <input type="txt" name="message" placeholder ="Unesite vašu poruku" className="footer-input2" />
          </form>
